...
import { UNAME, PASSWD, KNOWN_KEY_URL, NO_MORE_LEAKS_HEADER, POSITIVE_MATCH_URL, } from "./constants.js";
...
export async function responseProvider(request) {
    ...
    if (body && isValidBody(body)) {
        ...
        try {
            const normalizedUnamePasswd = getNestedValue(body, UNAME).toLowerCase().normalize("NFC") +
